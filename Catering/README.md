## Catering Program in Java##

There is a party with 10 guests in my house. You have hired a waiter from a catering company to serve you. We have "borek", "cake" and "drink" to be consumed by my 10 guests.
...
Simulate the scheduling by implementing in Java, showing every step that the guests and the waiter do.
### Main Class
```Java
package practice;
